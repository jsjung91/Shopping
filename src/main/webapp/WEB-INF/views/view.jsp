...
<table align="center" width="600" border="1"
 ...
 bordercolor="navy" cellpadding="4" cellspacing="0">
		<tr>
			<td width="40%">제품 분류</td>
			<td width="60%">${ requestScope.vo.category }</td>
		</tr>
		<tr>
			<td width="40%">제품 번호</td>
		...
		<img width="400" src="/images/${ vo.p_image_l }">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center">
				<input type="button" 
				value="장바구니 담기"
onclick="location.href='/cart_insert?idx=${ vo.idx }'"/>
				<input type="button" 	value="장바구니 보기"
onclick="location.href='/cart_list'"/>
<input type="button" value="수정" onclick="location.href='/cart_up_form?idx=${vo.idx}'">
			</td>
		</tr>
	</table>
</body>
